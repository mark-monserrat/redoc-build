...
export declare const Tabs: import("styled-components").StyledComponentClass<import("react-tabs").TabsProps, import("../theme").ResolvedThemeInterface, Pick<import("react-tabs").TabsProps, "className" | "onSelect" | "defaultFocus" | "defaultIndex" | "disabledTabClassName" | "domRef" | "forceRenderTabPanel" | "selectedIndex" | "selectedTabClassName" | "selectedTabPanelClassName"> & {
